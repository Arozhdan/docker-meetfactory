<template>
  <div class="homepage container-full">
    ...
    <div class="view-tablet mob--full-width mb-9">
      <client-only>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-4 mob--full-width">
      <EventCard />
      <EventCard />
      <EventCard />
    </div>
    <div class="divider divider--mob" />
    <div class="mt-9">
      <h1 class="h1">
        Nyní hrajeme v divadle
      </h1>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mob--full-width mt-8 gap-0 md:gap-x-10 flex-wrap">
        <EventCard />
        <EventCard />
      </div>
    </div>
    ...
    <div class="my-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 mob--full-width mt-8 gap-x-0 gap-y-4 sm:gap-x-10 flex-wrap">
    ...
    <div class="mb-12 gap-x-10 flex  md:grid md:grid-cols-2 lg:grid-cols-3 pb-10 overflow-mob-scroll mob--full-width gap-y-8">
      <div class="overlay-image__caption">
        <h2 class="h2 mb-2">
          Plánované výstavy
        </h2>
        <OverlayImage />
      ...
      <div class="overlay-image__caption">
        ...
        <OverlayImage />
      </div><div class="overlay-image__caption">
        <h2 class="h2 mb-2">
          Plánované výstavy
        </h2>
        <OverlayImage />
    ...
    <div class="my-9 homepage__calendar">
      <h1 class="h1 mb-3">
        Kalendář akcí
      </h1>
      <FullCalendar />
    </div>
    <div class="homepage__calendar--mobile mb-8">
      <Date>Kalendář akcí</Date>
    </div>
    <div class="mb-12 gap-x-10 flex gap-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 pb-10 overflow-mob-scroll mob--full-width">
      <EventCardSecondary />
      <EventCardSecondary />
      <EventCardSecondary />
      <EventCardSecondary />
